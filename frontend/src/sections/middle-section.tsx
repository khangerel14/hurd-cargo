        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mt-20'>
          ...
          <Card className='bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300'>
            ...
            <div className='flex flex-col gap-1'>
              <p className='text-gray-500 mt-1'>
                🚛 Тээвэрлэлтийн явцад эмзэг, хагарамтгай, эвдрэлд амархан өртөх
                бараа бүтээгдэхүүнийг <span>сайтар сав баглаа боодолгүй</span>{' '}
                тохиолдолд захиалахгүй байхыг хүсье.
              </p>
              <p className='text-gray-500 mt-1'>
                🚛 Иймд хэрэв{' '}
